...
func makeDefaultList()-> [Shape] {
    ...
    newList.append(Shape(name: "Rat", size: 0, ac: 10, hp: 1, cr: -4, speed: 20, cspeed: 0, sspeed: 0, fspeed: 0, str: 2, dex: 11, con: 9, int: 2, wis: 10, cha: 4, dv: 30, bs: 0, abilities: [["Keen Smell": "you have advantage n perception checks that rely on smell."]], actions: [["Bite": "+0 to hit, reach 5 ft.  On a hit deal 1 piercing damage."]]))
    return newList
}
